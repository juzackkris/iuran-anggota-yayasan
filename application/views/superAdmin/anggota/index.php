                        ...
                        foreach ($anggota as $a) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a onclick="return confirm('Yakin Hapus')" class="btn btn-sm btn-danger " href="<?php echo base_url('superAdmin/anggota/hapus/' . $a['id_anggota']) ?>"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                </table>
