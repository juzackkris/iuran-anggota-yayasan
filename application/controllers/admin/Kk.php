...
class Kk extends CI_Controller
{
    ...
    public function ubahDataKk($id)
    {
        ...
        for ($i = 0; $i < 360; $i++) {
            ...
            $jatuhTempo = date('d-m-Y', strtotime($AwalJatuhTempo));
        ...
        //     $date->modify('+1 month');
        //     $dateMon = $date->format('d-m-Y');
        //     $date2 = $dateMon;
        //     // $bulan = $bulanIndo[date('F', strtotime($date2))] . " " . date('Y', strtotime($date2));
        //     $bulan = date('F', strtotime($date2)) . " " . date('Y', strtotime($date2));
        //     $i++;
        //     $data = [
        //         'id_keluarga' => $id,
        //         'bulan' => $bulan,
